...
#endif
                VL_FATAL_MT("/home/ubuntu/EE219_project/EE219-AICS-2025/projects/project/hw/vsrc/top.v", 11, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__vram_r_ena = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__vram_r_addr = VL_RAND_RESET_Q(64);
    ...
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT__inst_vle32_v = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT__inst_vse32_v = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT__inst_vadd_vv = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT__inst_vmul_vv = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT____VdfgTmp_hcc847049__0 = 0;
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT____VdfgTmp_h24289dee__0 = 0;
    vlSelf->top__DOT__RV_VECTOR__DOT__u_decode__DOT____VdfgTmp_hcffc3720__0 = 0;
    vlSelf->top__DOT__RV_VECTOR__DOT__u_execute__DOT__i = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__RV_VECTOR__DOT__u_vregfile__DOT__i = VL_RAND_RESET_I(32);
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        VL_RAND_RESET_W(512, vlSelf->top__DOT__RV_VECTOR__DOT__u_vregfile__DOT__vregfile[__Vi0]);
    }
